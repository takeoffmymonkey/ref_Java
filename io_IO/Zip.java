...
@Ntrstn("Пакет java.util.zip предоставляет классы для чтения и записи стандартных файловых форматов " +
        "ZIP и GZIP, классы для компрессии и декомпрессии данных при помощи алгоритма DEFLATE, " +
