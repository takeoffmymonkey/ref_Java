package types_references_enums;
 ...
 *      - явное наследование запрещено (не может быть суперклассом или подклассом), т.к. уже
 *      наследует
...
@Ntrstn("Перечисления могут имплементировать интерфейсы")
