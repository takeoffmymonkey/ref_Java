...
/* NIO
 * - с 1.4
 * - ориентирована на единственную цель - скорость
 *      - работа с файлами и сетью
 *      - даже старый IO был переписан с учетом достижений NIO
 *          - так что улучшениями можно пользоваться даже без явного NIO
 *      - за счет структур, близких к средствам самой ОС - каналам и буферам
 *      - размер буфера играет большое значение для скорости
...
/* CHANNEL VS PIPE
 * - channel: еще один источник данных
 * - pipe: налаживают обмен данными между различными процессами
 * */
