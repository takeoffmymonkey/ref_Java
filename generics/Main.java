...
@Ntrstn("Учитывая, что в обобщенном классе в runtime неизвестно, какой конкретный параметр типа " +
        ...
        "обобщенного класса, такой конкретный объект. При этом ")
...
@Ntrstn("Границы перечисляются после слова extends, что для интерфейсов, указанных как граница, " +
        "подразумевает implements")
