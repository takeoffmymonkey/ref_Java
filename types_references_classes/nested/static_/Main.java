...
@Ntrstn("Как и для других подклассов, чтобы обратиться к нестатическим членам статического подкласса, " +
        "сначала нужно создать его экземпляр")

@Ntrstn("Обрамляющий класс может обратиться к вложенному классу только по полному имени.")
...
@Ntrstn("Вложенные классы являются членами обрамляющего класса - т.е. наследуются. Кроме того, они " +
        "могут быть унаследованы и независимо от обрамляющего класса наследовать любой класс или " +
        "имплементировать любой интерфейс - этим они могут обеспечить множественность реализации. " +
        "Также, как члены класса, они могут иметь любые модификаторы доступа и должны находиться на " +
        "уровне других членов")

@Ntrstn("К остальным преимуществам подклассов относится возможность группировать классы логически, " +
        "т.е. в внутри класса Машина будут подклассы Руль, Колесо и т.д. Кроме этого, улучшается " +
