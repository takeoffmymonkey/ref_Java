...
@Ntrstn("Важной особенностью внутренних классов является то, что это не просто механизм сокрытия " +
        "имен, а то, что у них есть доступ ко всем членам обрамляющего класса, в т.ч. приватным!")
@Ntrstn("Доступ к членам обрамляющего класса обеспечивается ссылкой на него, и подразумевает, что " +
        "внутренний класс нельзя создать без экземпляра внешнего")
@Ntrstn("При необходимости, получить ссылку на обрамляющий класс можно с помощью .this")
@Ntrstn("При необходимости создать объект внутреннего класса, нужно использовать .new после ссылки " +
        "на объект (а не имя!) внешнего класса. При этом тип ссылки при объявлении должен иметь " +
        "форму ВнешнийКласс.ВнутреннийКласс. Напр. Outer.Inner i = outer.new Inner(); Т.е. ссылка " +
        "на объект внешнего класса должна существовать к моменту создания внутреннего")
@Ntrstn("Не могут объявлять свои поля и методы как static??")
@Ntrstn("Обычно внутренний класс наследует от класса или реализует интерфейс, а код внутреннего " +
        "класса манипулирует объектом внешнего класса, в котором он был создан. Значит, можно " +
        "сказать, что внутренний класс - своего рода окно во внешний мира")
@Ntrstn("Наиболее веская причина для использования внутренних классов (в контексте реализации " +
        "интерфейса внешним классом или внутренним): каждый внутренний класс " +
        "способен независимо наследовать определенную реализацию. Таким образом, внутренний класс " +
        "не ограничен при наследовании в ситуациях, где внешний класс уже наследует реализацию. " +
        "Внутренний класс выступает как довесок множественного наследования: интерфейсы берут на " +
        "себя часть этой задачи, в то время как внутренние классы фактически обеспечивают " +
        "множественное наследование реализации. Т.е. внутренние классы позволяют наследовать от " +
        "нескольких не-интерфейсов. Т.е. внутренний класс не завязан на том, что там наследует " +
        "внешний, и может сам наследовать что-то или имплементировать. При этом разных внутренних " +
        "классом может быть сколько угодно. Т.е. внутренний класс не создает связь является с " +
        "внешним, но является отдельной сущностью ")
@Ntrstn("Внутренний класса является объектно-ориентрированным замыканием, т.к. он содержит не только " +
        "информацию об объекте внешнего класса (место создания), но также у него есть ссылка на весь " +
        "объект внешнего класса, с помощью которой он может манипулировать всеми членами этого объекта")
