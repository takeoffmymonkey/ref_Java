...
@Ntrstn("Т.к. имя локального внутреннего класса недоступно за пределами его зоны видимости, " +
        "единственным доводом в пользу локального внутреннего класса против анонимного может быть " +
        "только необходимость в именованном конструкторе и/или перегруженных конструкторах; " +
        "безымянные внутренние классы вправе задействовать только инициализацию экземпляра. " +
        "Единственная причина использования локального вместо анонимного класса - возможность " +
        "создания более чем 1 объекта такого класса")
