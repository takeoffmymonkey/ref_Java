...
/* ВИДЫ
 * - статический (вложенный, nested): с модификатором static
 *
...
@Ntrstn("Чтобы обратиться к нестатическим членам вложенных и внутренних подклассов, нужно сначала " +
...
@Ntrstn("Вложенный и внутренний (только простой!) классы являются членами обрамляющего класса - т.е. " +
        "наследуются. Кроме того, они могут быть унаследованы и независимо от обрамляющего класса " +
        "наследовать любой класс или имплементировать любой интерфейс - это второе главное " +
        "преимущество - этим они могут обеспечить множественность реализации. Также, как члены класса, " +
        "они могут иметь любые модификаторы доступа и должны находиться на уровне других членов")
