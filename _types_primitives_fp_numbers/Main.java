package _types_primitives_fp_numbers;
...
public class Main {
    ...
    public static void main(String[] args) {
         ...
         * - Вместо - класс __numbers_BigDecimal (максимальная возможная точность представления)*/
        double d = 2.0 - 1.1;
        BigDecimal bd = new BigDecimal(2.0 - 1.1);
        System.out.println("2.0 - 1.1 = " + d); //0.8999999999999999
        System.out.println("__numbers_BigDecimal: 2.0 - 1.1 = " + bd); //0.899999999999999911182158029987476766109466552734375
